...
const H3 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      role='heading'
      aria-level='3'
      className={cn('text-2xl font-semibold tracking-tight text-foreground web:select-text web:scroll-m-20', className)}
      ref={ref}
      {...props}
    />
  );
...
const H4 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      role='heading'
      aria-level='4'
      className={cn('text-xl font-semibold tracking-tight text-foreground web:select-text web:scroll-m-20', className)}
      ref={ref}
      {...props}
    />
  );
