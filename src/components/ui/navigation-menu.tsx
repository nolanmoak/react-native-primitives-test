...
const NavigationMenu = React.forwardRef<NavigationMenuPrimitive.RootRef, NavigationMenuPrimitive.RootProps>(
...
const NavigationMenuList = React.forwardRef<NavigationMenuPrimitive.ListRef, NavigationMenuPrimitive.ListProps>(
  ({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.List
      ref={ref}
      className={cn('web:group flex flex-1 flex-row items-center justify-center gap-1 web:list-none', className)}
      {...props}
    />
  )
);
